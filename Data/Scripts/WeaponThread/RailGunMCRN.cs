...
{   // Don't edit above this line
    ...
    { 
        ...
        Loading = new AmmoLoading
        {
            RateOfFire = 60,
            BarrelsPerShot = 1,
            FakeBarrels = Options(enable: false, converge: true), // use virtual barrels to save performance at the cost of hit accuracy, converge beams to save even more performance
    ...
    {
        BaseDamage = 1500f, 		// how much damage the projectile does
        Mass = 2500f,
        Health = 0,
        BackKickForce = 2.5f,
        ObjectsHit = Options(maxObjectsHit: 15, countBlocks: false), // 0 = disabled, value determines max objects (and/or blocks) penetrated per hit
        ...
        Trajectory = new AmmoTrajectory
        {
            ...
            Smarts = new Smarts
            {
                Inaccuracy = 2f, // 0 = perfect, aim pos will be 0 - # meters from center, recalculates on miss.
    ...
    Graphics = new GraphicDefinition
    {
        ...
        Particles = new ParticleDefinition
        {
            Ammo = new Particle
            {
                ...
                Extras = Options(loop: true, restart: false, distance: 5000, duration: 1, scale: 0.6f),
            },
            Hit = new Particle
            {
